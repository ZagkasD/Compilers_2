...
public class grammar_v3_2Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "NEWLINE", "ID", "INT", "REL_OP", 
			"ADD_OP", "MUL_OP", "BLOCK_COMMENT", "COMMENT", "WS"
		};
	}
	...
	public grammar_v3_2Lexer(CharStream input) {
		super(input);
