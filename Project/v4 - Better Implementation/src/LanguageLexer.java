...
public class LanguageLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ADD_OP", "MUL_OP", "REL_OP", "ELSE", "IF", "WHILE", "RETURN", "CLASS", 
			"DEF", "INIT", "PASS", "PRINT", "AND", "NOT", "OR", "NAME", "MAIN", "LPARA", 
			"RPARA", "LBRAC", "RBRAC", "COMMA", "COLON", "POINT", "AssignOP", "ID", 
			"INT", "BLOCK_COMMENT", "COMMENT", "WS"
		};
	}
